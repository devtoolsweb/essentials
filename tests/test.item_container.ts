...
class Test extends ItemContainerMixin(ItemMixin(NStructContainerMixin<IItem>(StandardNStructChild(BaseClass)))) {}

const createItemized = (n = 10): Test => {
...
test('select item', () => {
    ...
    obj.unselectItem(obj.getItemAt(j) as IItem)
